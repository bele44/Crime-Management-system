...
?>
<a href="Preventivepoliceresponsecomplain.php"><font size="5px" color="#363ecf" style="text-decoration: none;">Complaint appointment list (&nbsp;<?php echo"<font color='#da240a'>".($countt)."</font>"; ?>&nbsp;)</font></a>
<br>
