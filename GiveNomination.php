          ...
          <tr>
             <td>      
              <div id="ContentLeft">
			   ...
			   <div id="ContentCenter" style="width: auto;height:600px;border:solid 4px #dldbeg;overflow:scroll;overflow-y: scroll">
				<br>
				<fieldset style="width: 700px;margin: auto;">
				  ...
				  <form action="" method="post">
					...
					<script type="text/javascript">
					   ...
					   f1.add(Validate.Format,{pattern: /^[0-9a-zA-Z]+$/ ,failureMessage: " please Enter ehither number or characters"});
					   f1.add( Validate.Length, { minimum:1, maximum: 30,failureMessage:"the characters must be less than 30" } );
				 	</script>
					...
					<tr><td>  Description:</td><td><textarea name="description"id="disc" placeholder="Enter your suggestion......"
					style="width: 400px;height: 60px;" ></textarea></td></tr>
					<script type="text/javascript">
				       var f1 = new LiveValidation('disc');
					  ...
					  if(isset($_POST['send']))
						...
						'$description','unseen','new')";
							...
							if($insert)
							{
								...
								window.location=\'GiveNomination.php\';</script>';
								echo $x; 
							}
							else
							{
