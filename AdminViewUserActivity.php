          ...
          <tr>
            	 ...
            	 <td>
				   ...
				   <td>
			          ...
			          <div style="border:solid 2px #dldbeg;overflow:scroll;overflow-y: scroll;">
...
<a href="adminlogfileuseratwork.php"><font size="5px" color="#a04eb1">List of User Activities (&nbsp;<?php 
$count_item=mysqli_query($con, "select * from logfiletable where logout_time='still at work'" ) or die(mysql_error());
...
$sql = "select * from logfiletable ORDER BY login_time DESC";
	...
	//$rs = $pager->paginate();		
	$re = $con->query($sql);							
$query1 = mysqli_query($con, "select * from logfiletable ORDER BY login_time DESC")
or die(mysql_error());
...
<tr><th>logfile_id</th><th>User_ID</th> <th>User_Name</th><th>User_Role</th><th>Login_time</th><th>Logout_time</th>
	<th> Start_time</th><th>Activity_type</th><th>Users_Activities_performed</th><th>Ip_address</th><th>Date of user_Login</th></tr>
        <?php
		//
