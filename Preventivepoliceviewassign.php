...
<a href="Preventivepoliceacceptnominations.php"><i><font size="5px" color="#363ecf" style="text-decoration: none;"> Number of nomination Recorded (&nbsp;<?php echo"<font color='#da240a'>".($count)."</font>"; ?>&nbsp;)</font></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
...
<td><?php echo '<a href="Preventivepoliceupdatenominations.php?No_Id='.$row['No_Id'].'">Accept</a>';?></td>
</div>
