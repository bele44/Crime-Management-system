...
<div id="wrapper">
	...
	<div style="border:solid 4px #dldbeg;overflow:scroll;overflow-y: scroll">
	 ...
	 if(isset($_POST['search']))
		...
		if($con)
		{
		$sql="select * from accused where firstname='$searchkey'";
		...
		if($row3=mysqli_fetch_array($recordfound))
	      {
				echo"<tr> <td>". $row3["accused_id"]."</td><td>". $row3["firstname"]."</td> <td>". $row3["fathername"]."</td>
				<td>". $row3["gfathername"]."</td><td>". $row3["sex"]."</td><td>". $row3["age"]."</td><td>". $row3["phoneno"]."</td>
				<td>". $row3["educationlevel"]."</td><td>". $row3["email"]."</td>
				<td>". $row3["kebele"]."</td><td>". $row3["village"]."</td><td>". $row3["date"]."</td><td><img src=". $row3["photo"]." style=width:60px; height:80px;></td>
			...
			<a href="CriminalCase.php">See Detail about FIR</a>
			<br><br><br>
			<?php	
			}
		}
			...
			?>	
			   ...
			   <table border="0px" width="550px" >
				<form action="" method="post" enctype="multipart/form-data" name="myForm">
					...
					<tr><td colspan="4"><h2 style="font-size:25px;text-align: center; color: #5178e1;"><u>Accused Registration Form</u></h2></td></tr>
					<tr><td>Accused ID:</td><td colspan="2"><input type="text"name="accused_id" id="accused_id" placeholder="Enter accuserID Number">
						</td></tr>
					     <script type="text/javascript">
				      	 var f1 = new LiveValidation('accused_id');
					  	 f1.add(Validate.Presence,{failureMessage: "Enter the accused id"});
					    ...
					    <tr><td>Accuser ID:</td><td><input type="text"name="accuser_id" id="accuser_id" placeholder="Enter accusedID Number"></td>
					     <script type="text/javascript">
				       ...
				       <td>Education Level:</td><td><input type="text" name="educationlevel" id="educationallevel"placeholder="Enter Education level">
				             </td></tr>
					 <script type="text/javascript">
					...
					<tr><td>  First Name:</td><td><input type="text" name="firstname" id="firstrname"placeholder="Enter First Name"></td>
						 ...
						 <script type="text/javascript">
					  	 ...
					  	 f1.add(Validate.Format,{pattern: /^[a-zA-Z0-9_.@\-+]+/ ,failureMessage: "You allowed to enter number,symbole and charchter"});
					...
					<tr><td>  Father Name:</td><td><input type="text" name="fathername" id="fathername"placeholder="Enter Father Name">
						 <script type="text/javascript">
					  	 ...
					  	 f1.add( Validate.Length, { minimum:4, maximum: 15,failureMessage:"the characters must be less than 15" } );
					 		...
					 		</td><td>  Kebele:</td><td><input type="text"name="kebele"id="kebele" placeholder="Enter kebele"></td></tr>
					 	 <script type="text/javascript">
					...
					<tr><td>  G.Father Name:</td><td><input type="text" name="gfathername"id="gfathername" placeholder="Enter Grand Father Name"></td>
					 	<script type="text/javascript">
					  	 ...
					  	 f1.add(Validate.Presence,{failureMessage: "Enter  Accuser G.faher name"});
					  	 f1.add(Validate.Format,{pattern: /^[a-zA-Z]+$/ ,failureMessage: "You allowed to enter charachter only"});
					  	 f1.add( Validate.Length, { minimum:4, maximum: 15,failureMessage:"the characters must be less than 15" } );
				 		</script>
				 		<td>  Village:</td><td><input type="text" name="village"id="village" placeholder="Enter village "></td></tr>
					  	 ...
					  	 f1.add(Validate.Presence,{failureMessage: "Enter the village"});
					  	 f1.add(Validate.Format,{pattern: /^[a-zA-Z0-9]+$/ ,failureMessage: "You allowed to enter character and number only"});
					  	 f1.add( Validate.Length, { minimum:2, maximum: 15,failureMessage:"the characters must be less than 15" } );
				 		</script>
					  ...
					  if(isset($_POST['Register']))
						{	
							...
							if($con)
								...
								{	
					$sql="Insert into accused values('$accused_id','$accuser_id','$firstname','$fathername','$gfathername','$sex','$age','$phoneno',
							    '$educationlevel','$email','Active','$kebele','$village','$date','$photopath','$description')";
								$insert=mysqli_query($con,$sql);
								if($insert)
								{
									$x='<script type="text/javascript">alert("accused is recorded sucessfully !");
										window.location=\'RegisterAcussed.php\';</script>';
										echo $x;
									}
									else
								   	{
