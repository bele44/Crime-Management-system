...
<div id="wrapper">
      ...
      <table width="100%" cellspacing="0px">
            	 ...
            	 <td>
			      ...
			      <?php
                   ...
                   if(isset($_GET['ID']))
	                  {
   							$accuser_id=$_GET['ID'];
							$sql="select * from accuser where accuser_id='$accuser_id'";  							                         						
								$recordfound=mysql_query($sql,$con);
								while($row=mysql_fetch_assoc($recordfound))
							{
							echo "<fieldset>";
							echo "<h1 align='center' style='background:#1f618d;color:white;'>Update Accuser Profile </h1>";
							echo "<form action='' method=post>
							<table align='center'>
							<tr><td style='font-size: 18px'> ID No:</td><td><input type=text name=accuser_id readonly value='".$row["accuser_id"]."' 
							...
							style='height: 28px'></td></tr>";
							echo "<tr><td style='font-size: 18px'>Date:</td><td><input type=date name=status value='".$row["date"]."' 
							style='height: 28px'></td></tr>";
       ...
       $sql="update accuser set firstname='$firstname',fathername='$fathername',gfathername='$gfathername',sex='$sex',age='$age',phoneno='$phoneno',
       city='$city',kebele='$kebele',village='$village',date='$date',photo='$photo',description='$description' where accuser_id='$accuser_id'";
		$updated=mysql_query($sql,$con);
		if($updated)
		{
			echo " one record updated  successfully!";
			header('location:ViewAccuser.php');
		}
