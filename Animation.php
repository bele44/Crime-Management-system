				    ...
				    <div id="jssor_1" style="position:relative;margin:1px auto;
					  ...
					  overflow:hidden;visibility:hidden;">
						...
						background-color:rgba(0,0,0,0.7);">
							...
							background:url('img/loading.gif') no-repeat center center;top:0px;left:0px;width:80%;height:80%;">
							</div>
				        </div>
				        <div data-u="slides" style="cursor:default;position:relative;top:0px;
						left:0px;width:650px;height:250px;overflow:hidden;">
				            <div>
				                <img data-u="image" src="Images/p1.jpg" />
								...
								color:#ffffff;line-height:30px;text-align:center;">police celebration day at Assosa city</div>
				            </div>
				            <div>
				                <img data-u="image" src="images/D0.jpg" />
								...
								font-size:20px;color:#ffffff;line-height:30px;text-align:center;">Police Conference on the Station</div>
				            </div>
				            <div>
				                <img data-u="image" src="photo/FemailPoliceOfficer.png"/>
				                <div data-u="caption" data-t="2" style="position:absolute;
								top:30px;left:-380px;width:350px;height:50px;z-index:0;
								background-color:rgba(235,81,0,0.5);font-size:20px;
								color:#ffffff;line-height:30px;text-align:center;">Assosa city Police Station manager </div>
				            </div>
				           
				            <div>
				                <img data-u="image" src="Images/p2.jpg"/>
								...
								color:#ffffff;line-height:30px;text-align:center;">police head give advice for people </div>
				            </div>
				            
				            	<div>
				                <img data-u="image" src="images/cartoon.jpg" />
				                <div data-u="caption" data-t="2" style="position:absolute;
								top:30px;left:-380px;width:350px;height:30px;z-index:0;
								background-color:rgba(235,81,0,0.5);font-size:20px;
								color:#ffffff;line-height:30px;text-align:center;">polices participating in development of the country </div>
				            </div>
				           
				           <a data-u="any" href="http://www.jssor.com" style="display:none">You shoud be free from crime!</a>
				        </div>
				        <!-- Bullet Navigator -->
