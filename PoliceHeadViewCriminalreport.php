...
<html>
<head>
<title>View Crime Report page</title>
...
$activity_type="police head view crime report";
...
if(isset($_POST['search']))
{
	$activity="police head view crime report[police head ID:$uid,Name:$fullname]";
