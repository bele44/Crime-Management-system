             ...
             <td>      
              <div id="ContentLeft">
				...
				?> 
				  ...
				  <div style="width: auto;height:600px;border:solid 4px #dldbeg;overflow:scroll;overflow-y: scroll">
					<br>
				  <center><fieldset>
				  <table border="0px" width="550px"  >
				  <form action="" method="post">
				    <tr><td colspan="4"><h2 style="font-size:25px;text-align: center;color: #2684d9">Give Nomination</h2></td></tr>
