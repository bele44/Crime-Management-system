...
<?php
$query = mysqli_query($con,"select * from nominationmissingperson where status='unseen'");
$count = mysqli_num_rows($query);
?>		
										
<a href="viewnominationmisingcriminal.php"><font size="5px" color="#363ecf" style="text-decoration: none;">Number of Recordes Nominated by citizens (&nbsp;<?php echo"<font color='#da240a'>".
	($count)."</font>"; ?>&nbsp;)</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
...
$sql = "select * from nominationmissingperson where status='unseen'";
	...
	$rs = $con->query($sql);									
//$query1 = mysql_query("select * from nominationmissingperson where status='unseen' ")
//or die(mysql_error());
	$count = $rs->num_rows;	
	if ($count != '0'){?>
...
<td><?php echo '<a  href="Assignpoliceformisperson.php?NMP='.$row['NMP'].'">Assign_police</a>';?></td>
</div>
