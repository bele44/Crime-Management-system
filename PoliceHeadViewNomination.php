...
<?php
$query = mysqli_query($con,"select * from nomination WHERE status2='new' ORDER BY date DESC")
or die(mysqli_error());
$count = mysqli_num_rows($query);
?>																				
<a href="PoliceHeadViewsavedNomination.php"><font size="5px" color="#a04eb1">Number of record nominated by Citizens(&nbsp;	
	<?php 
...
<font size="3px">
<?php
$sql = "select * from nomination where status2='new' ORDER BY date DESC";
	//Create a PS_Pagination object
	//$pager = new PS_Pagination($con, $sql, 5, 8);
 	//The paginate() function returns a mysql result set for the current page
	$rs = $con->query($sql);								
$query1 = mysqli_query($con,"select * from nomination where status2='new' ORDER BY date DESC")
or die(mysqli_error());
...
<td><?php echo '<a  href="policeheadsavenomination.php?id='.$row['No_Id'].'">Accept</a>';?></td>
<td><?php echo '<a  href="Assignpoliceforcriminals.php?id='.$row['No_Id'].'">Assign</a>';?></td>
</div>																			
<?php 
}
?>
