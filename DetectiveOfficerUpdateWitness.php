...
<html>
<head>
<title>Detective Officer Update Witness page</title>
...
<div id="wrapper">
      ...
      <table width="100%" cellspacing="0px">
            	 ...
            	 <td>
			      ...
			      <?php
                   ...
                   if(isset($_GET['ID']))
	                  {
   							$witness_id=$_GET['ID'];
							$sql="select * from witness where witness_id='$witness_id'";  							                         						
								$recordfound=mysql_query($sql,$con);
								while($row=mysql_fetch_assoc($recordfound))
							{
							echo "<fieldset>";
							echo "<h1 align='center' style='background:#1f618d;color:white;'>Update Witness Profile </h1>";
							echo "<form action='' method=post>
							<table align='center'>
							<tr><td style='font-size: 18px'> ID No:</td><td><input type=text name=witness_id readonly value='".$row["witness_id"]."' 
       ...
       $sql="update witness set firstname='$firstname',fathername='$fathername',gfathername='$gfathername',sex='$sex',age='$age',phoneno='$phoneno',
       city='$city',kebele='$kebele',village='$village',date='$date',photo='$photo',description='$description' where witness_id='$witness_id'";
		$updated=mysql_query($sql,$con);
		if($updated)
		{
			echo " one record updated  successfully!";
			header('location:DetectiveOfficerViewWitness.php');
		}
