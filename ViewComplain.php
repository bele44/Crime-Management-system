...
<a href="Preventivepolicesavedcomplain.php"><font size="5px" color="#363ecf" style="text-decoration: none;"> Complain record (&nbsp;<?php echo"<font color='#da240a'>".($count)."</font>"; ?>&nbsp;)</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
...
$sql = "select * from complainrequest where status='unseen'";
	...
	$rs = $con->query($sql);									
$query1 = mysqli_query($con,"select * from complainrequest where status='unseen' ")
or die(mysqli_error());
...
<td><?php echo '<a href="Preventivepoliceacceptcomplain.php?complaint_id='.$row['complaint_id'].'">Accept</a>';?></td>
</div>											
<?php
 }
	?>
	...
	<?php
		//echo '<div style="text-align:center">'.$pager->renderFullNav().'</div>';
			...
			<div class="alert alert-info"><i class="icon-info-sign"></i> <font size="3px">No Complain to be requested!</div>
			<?php } ?>
