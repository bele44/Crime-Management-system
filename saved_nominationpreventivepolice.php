...
<a href="saved_nominationpreventivepolice.php"><i class="icon-envelope-alt"><font size="4px" color="#a04eb1">Saved police assinn(&nbsp;<?php 
...
<font size="3px">							
									<?php
$query1 = mysqli_query($con,"select * from nomination where status='seen' ORDER BY date DESC")
or die(mysqli_error());
?>

<?php
$sql = "select * from nomination where status='seen' ORDER BY date DESC";
...
<?php
	...
	<div class="alert alert-info"><i class="icon-info-sign"></i> <font size="3px">No body login to the system!</div>
	<?php } ?>
	</form>		
