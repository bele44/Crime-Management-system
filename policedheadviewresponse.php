...
$sql = "select * from nominationmissingperson where status='responced'";
	...
	$rs = $con->query($sql);									
$query1 = mysqli_query($con,"select * from nominationmissingperson where status='responced' ")
or die(mysqli_error());
...
<td><?php echo '<a  href="policeheadacceptresponce.php?id='.$row['NMP'].'">Accept</a>';?></td>
</div>
