...
<html>
<head>
<title>Police Head View Employee Page</title>
...
$activity_type="police head view employee";
...
<a href="PoliceHeadViewEmployee.php"><i class="icon-envelope-alt"><font size="4px" color="#a04eb1" style="margin-left: 30px;">
...
$sql = "select * from employee ";
	$activity="police head view employee of the station[Police head ID:$uid,Name:$fullname]";
